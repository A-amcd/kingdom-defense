...
pygame.display.set_caption("鸿蒙防线 - 终极版")
...
class Game:
    ...
    def draw_menu(self):
        ...
        subtitle = small_font.render("终极版 - 四大主题关卡", True, (200, 200, 150))
        screen.blit(subtitle, subtitle.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 30)))

        hint = font.render("点击任意处开始游戏", True, (200, 200, 200))
        screen.blit(hint, hint.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 20)))

        btn = pygame.Rect(SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 + 80, 200, 50)
        pygame.draw.rect(screen, (80, 100, 180), btn)
        pygame.draw.rect(screen, (255, 255, 255), btn, 3)
    ...
    def draw_level_select(self):
        ...
        for i, (level_id, config) in enumerate(level_list):
            ...
            pygame.draw.rect(screen, config['ui_primary'], btn)
