...
# ================================
COLORS = {
    'background': (30, 30, 40),   # 游戏背景色（深灰色）
    'grid': (45, 45, 60),         # 网格线颜色
    'path': (100, 80, 60),        # 敌人行进路径颜色（棕色）
...
class Game:
    ...
    def draw_ui(self):
        ...
        pygame.draw.rect(screen, (40, 40, 55), top_bar_rect)
        
        # 金币显示（左上角，带背景色块）
        gold_bg_rect = pygame.Rect(8, 5, 100, 35)
        pygame.draw.rect(screen, (50, 50, 70), gold_bg_rect)
        ...
        pygame.draw.rect(screen, (50, 50, 70), lives_bg_rect)
        ...
        pygame.draw.rect(screen, (50, 50, 70), wave_bg_rect)
        ...
        pygame.draw.rect(screen, (50, 50, 70), (panel_x, panel_y, panel_width, panel_height))
        ...
        for tower_type, config in TOWER_CONFIG.items():
            ...
            if self.selected_tower_type == tower_type:
                pygame.draw.rect(screen, (60, 80, 100), item_bg_rect)
                pygame.draw.rect(screen, (255, 255, 255), item_bg_rect, 2)
            else:
                pygame.draw.rect(screen, (45, 45, 60), item_bg_rect)
        ...
        if self.selected_tower:
            ...
            pygame.draw.rect(screen, (40, 60, 80), (info_x, info_y, info_width, info_height))
